            ...
            <ul className="space-y-4">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-[#26C7C3] transition-colors duration-300"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[#26C7C3] transition-colors duration-300 flex items-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
