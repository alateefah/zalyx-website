      ...
      <div className="wrapper max-w-[1300px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center max-w-4xl mx-auto pb-12 pt-20">
          ...
          <p className="text-gray-300 mt-12 text-xl max-w-[720px] mx-auto leading-relaxed">
            Zalyx Technologies creates powerful, easy-to-use software solutions that simplify
            business operations, financial management, and everyday workflows.
          </p>
        </div>
          ...
          {[
            ...
            <div
              ...
              className={`rounded-2xl py-16 px-10 ${
                card.highlight ? "bg-[#dff9ff] text-[#0b0d13]" : "bg-[#111524] text-white"
              }`}
              style={
                card.highlight
            ...
            >
              ...
              <p className="mt-2 text-xl text-gray-300">{card.text}</p>
            </div>
          ))}
        </div>
      </div>
