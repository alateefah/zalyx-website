...
export default function TermsAndConditions() {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions — Zalyx Technologies</title>
      </Helmet>
      ...
      <div className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16 leading-relaxed">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-6">
            By downloading or using <strong>Zalyx Ledger</strong>, you agree to these Terms &
            Conditions (“Terms”). If you do not agree, do not use the app.
          </p>

          <h2 className="text-xl font-semibold mb-4">2. About the Service</h2>
          <p className="mb-6">
            Zalyx Ledger helps artisans and small businesses manage customers, orders, and business
            records. Future updates may include payment features.
          </p>
          ...
          <p className="mb-6">
            All app content, design, and software belong to Zalyx Innovations & Technologies Ltd.
            You’re granted a limited, non-exclusive license to use the app.
          </p>

          <h2 className="text-xl font-semibold mb-4">7. Payments (Future Feature)</h2>
          <p className="mb-6">
            When payment features are added, additional terms will apply and will be clearly
            communicated.
          </p>
          ...
          <p className="mb-6">
            ...
            service. You may stop using the app anytime.
          </p>

          <h2 className="text-xl font-semibold mb-4">9. Limitation of Liability</h2>
          <p className="mb-6">
            Zalyx is not responsible for any indirect, incidental, or consequential damages
          ...
          <p className="mb-6">
            We may update these Terms periodically. Continued use of the app means you accept the
            latest version, available at <strong>zalyx.io/terms</strong>.
          </p>
