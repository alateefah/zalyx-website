  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16 leading-relaxed">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-6">
          Zalyx Innovations & Technologies Ltd. (“Zalyx”, “we”, “our”, or “us”)
          is a private limited company registered in Nigeria with operations
          managed from Canada. We build digital tools that help artisans and
          small businesses manage their customers, orders, and finances through
          our product, <strong>Zalyx Ledger</strong>.
        </p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-1">
          ...
          <li>
            Business Data: customer lists, orders, transactions, and other
            information you record in the app.
          </li>
          <li>
            Usage Data: device type, app version, and analytics on how you use the app.
          </li>
        </ul>
        ...
        <p className="mb-6">
          We may share data with service providers (e.g., Twilio for OTP) and
          authorities if required by law. We never sell or rent your data.
        </p>

        <h2 className="text-xl font-semibold mt-10 mb-4">4. Data Retention & Security</h2>
        <p className="mb-6">
          We retain your data as long as necessary to provide the service or as
          required by law. Data is protected using encryption, secure hosting,
          and restricted access.
        </p>

        <h2 className="text-xl font-semibold mt-10 mb-4">5. Your Rights</h2>
        <p className="mb-6">
          You may access, update, or delete your information, or withdraw consent
          by contacting{" "}
          <a href="mailto:lateefah@zalyx.io" className="text-blue-600">
            lateefah@zalyx.io
          </a>
        ...
        <h2 className="text-xl font-semibold mt-10 mb-4">6. Changes</h2>
        <p>
          We may update this policy periodically. The latest version will always
          be available at <strong>zalyx.io/privacy</strong>.
        </p>
      </div>
    </div>
  );
