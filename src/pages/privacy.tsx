  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16 leading-relaxed">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-6">
          Zalyx Innovations & Technologies Ltd. (“Zalyx”, “we”, “our”, or “us”) is a private limited
          company registered in Nigeria with operations managed from Canada. We build digital tools
          that help artisans and small businesses manage their customers, orders, and finances
          through our product, <strong>Zalyx Ledger</strong>.
        </p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-1">
          ...
          <li>
            Business Data: customer lists, orders, transactions, and other information you record in
            the app.
          </li>
